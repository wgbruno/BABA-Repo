          ...
          txn.executeSql(
            ...
            function(tx, res) {
              ...
              if (res.rows.length == 0) {
                ...
                txn.executeSql("CREATE TABLE IF NOT EXISTS Player_Table(firstName VARCHAR(25), " 
                  + "lastName VARCHAR(25), age INT(2), number INT(15), height VARCHAR(10), "
                  + "points INT(3), rebounds INT(15), assists INT(15), blocks INT(15), steals INT(15), " 
                  + "fouls INT(2), turnovers INT(15))",
                  []
                );
              }
            }
            ...
            tx.executeSql("INSERT INTO Player_Table(firstName, lastName, age, number, height, "
                ...
                (tx, results) => {
                    ...
                    if (results.rowsAffected > 0) {
                        Alert.alert('Player Inserted Successfully');
                    } else
                        Alert.alert('Failed');
                }
            );
